...
// result= (snprintf_P(s, sizeof(s), PSTR("%s temperatureC=%f valid=%"), addr.toString().c_str(), temperatureC, valid).toString;
  result = String("%s temperatureC=%f valid=%") + addr.toString();// + String(temperatureC) + String(valid);
	return result;
}
